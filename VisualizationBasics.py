# -*- coding: utf-8 -*-
"""visualizationBasics.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1PaU0w1YkSrNh5D-JkBrYIbJnmYQsE7GK
"""
...
demo = pickle.load(urlopen(fullLink))
...
colorNom1 + scale_colour_brewer(type='qual',
                                palette = "Set1") + \
            theme_classic()

info2=ggplot(demo, aes(x='Culture', y='Functioning',fill='Regime'))
colorOr = info2 + geom_point (size=3,shape='o')
colorOr + scale_fill_brewer (palette = "OrRd") + theme_classic()
...
erase2 = leyenda + theme_classic() + theme(legend_title = element_blank())
repo1=erase2 + theme(legend_position="top")
repo2 = repo1 + coord_fixed(ratio=1) + guides(shape=guide_legend(nrow = 1))
